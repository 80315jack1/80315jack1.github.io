...
<p style="font-size: 14px; margin-top: 8px;">陽光</p>
    ...
    <div style="display: flex; flex-direction: column; gap: 15px; flex: 1 1 45%; max-width: 300px;">
      <div style="text-align: center;">
        <div style="aspect-ratio: 4 / 3; border-radius: 10px; overflow: hidden;">
          <img src="/assets/D2/亞霸介紹.jpg" style="width: 100%; height: 100%; object-fit: cover;">
        </div>
        <p style="font-size: 13px; margin-top: 6px;">亞霸的山周邊 1</p>
      </div>
      ...
      <div style="text-align: center;">
        ...
        <p style="font-size: 13px; margin-top: 6px;"早起的鳥有景看 3</p>
      </div>
    </div>
...
<div style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap; margin-bottom: 50px;">
  <div style="flex: 1 1 300px; max-width: 320px; text-align: center;">
    ...
    <p style="font-size: 14px; margin-top: 8px;">梨山</p>
  </div>
  <div style="flex: 1 1 300px; max-width: 320px; text-align: center;">
    <div style="aspect-ratio: 4 / 3; overflow: hidden; border-radius: 10px;">
      <img src="/assets/D2/梨山介紹圖.jpg" style="width: 100%; height: 100%; object-fit: cover;">
    </div>
    <p style="font-size: 14px; margin-top: 8px;">可以看到雪山、桃山等等山巒，至於剛剛的思源啞口早已看不見</p>
  </div>
</div>
...
<!-- 📝 段落 2_11 -->
<div style="max-width: 720px; margin: 40px auto; font-size: 16px; line-height: 1.8;">
下午換我繼續騎，從梨山下滑到台8縣88公里的路段相對輕鬆</p>
但在道路施工因為鐵板積水+我要拿肌樂所以摔了一跤</p>
不知是否因為這樣促發洪荒之力，感覺沒第一天那麼累，雖然還是沒大家快就是了
</div>
...
<div style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap; margin-bottom: 50px;">
  <div style="flex: 1 1 300px; max-width: 320px; text-align: center;">
    <div style="aspect-ratio: 4 / 3; overflow: hidden; border-radius: 10px;">
      <img src="/assets/D2/中轉合照.jpg" style="width: 100%; height: 100%; object-fit: cover;">
    </div>
    <p style="font-size: 14px; margin-top: 8px;">早上的南山</p>
  </div>
 <div style="flex: 1 1 300px; max-width: 320px; text-align: center;">
...
<!-- 📝 段落 2_11 -->
<div style="max-width: 720px; margin: 40px auto; font-size: 16px; line-height: 1.8;">
在其四公里就到達合歡山隧道，過了就是明天一早的重生(出發)地點
</div>
